...
public class ProfitOptimizerNewTest {
    private ProfitOptimizerNew profitOptimizer = new ProfitOptimizerNew();

    @Test
    public void testRandom() {
        int[] prices = new int[] {3, 5, 2, 8, 5, 2, 5, 10, 2, 1};
        ProfitOptimizerNew.Pair result = profitOptimizer.getProfit(prices);
